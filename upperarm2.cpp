    ...
    : m_count(0)
{
    ...
    bool res = loadOBJ("/home/zhuyifeng/Documents/graph/meshes/arm_test/UpperArm2.obj", vertices, normals);
...
void UpperArm2::add(const QVector3D &v, const QVector3D &n)
{
...
void UpperArm2::quad1(GLfloat x1, GLfloat y1,GLfloat z1,
...
void UpperArm2::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void UpperArm2::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
