...
bool LowerArm2::loadOBJ(
        ...
        std::cout<<vertexIndices.size()/3<<std::endl;
    ...
    : m_count(0)
{
    double l = 20.7f;
    double h = 0.5f;
    m_data.resize(10000000);
    width = 11.475f;
    std::vector<QVector3D> vertices;

    std::vector<QVector3D> normals;
    bool res = loadOBJ("/home/zhuyifeng/Documents/graph/meshes/arm_test/LowerArm2.obj", vertices, normals);
    std::cout<<"Size:"<<vertices.size()<<std::endl;
    for(int i=2; i<vertices.size()-2; i=i+3)
    {
       ...
       /* quad1(vertices[i].x(),vertices[i].y(),vertices[i].z(),
        ...
        quad1(vertices[i-2].x(),vertices[i-2].y(),vertices[i-2].z(),
              vertices[i-1].x(),vertices[i-1].y(),vertices[i-1].z(),
...
void LowerArm2::add(const QVector3D &v, const QVector3D &n)
{
...
void LowerArm2::quad1(GLfloat x1, GLfloat y1,GLfloat z1,
                ...
                QVector3D n1, QVector3D n2, QVector3D n3)
{
    ...
    //QVector3D n = QVector3D(1.0,1.0,1.0);
    add(QVector3D(x1*100.0, y1*100.0, z1*100.0), n);

    add(QVector3D(x2*100.0, y2*100.0, z2*100.0), n);
    add(QVector3D(x3*100.0, y3*100.0, z3*100.0), n);
//}
...
void LowerArm2::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void LowerArm2::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
