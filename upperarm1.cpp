    ...
    : m_count(0)
{
    ...
    bool res = loadOBJ("/home/zhuyifeng/Documents/graph/meshes/arm_test/UpperArm1.obj", vertices, normals);
...
void UpperArm1::add(const QVector3D &v, const QVector3D &n)
{
...
void UpperArm1::quad1(GLfloat x1, GLfloat y1,GLfloat z1,
...
void UpperArm1::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void UpperArm1::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
