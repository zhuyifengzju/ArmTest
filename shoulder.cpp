    ...
    : m_count(0)
{
    ...
    bool res = loadOBJ("/home/zhuyifeng/Documents/graph/meshes/arm_test/Shoulder.obj", vertices, normals);
...
void Shoulder::add(const QVector3D &v, const QVector3D &n)
{
...
void Shoulder::quad1(GLfloat x1, GLfloat y1,GLfloat z1,
...
void Shoulder::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void Shoulder::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
