    ...
    : m_count(0)
{
    ...
    bool res = loadOBJ("/home/zhuyifeng/Documents/graph/meshes/arm_test/Bat.obj", vertices, normals);
...
void Bat::add(const QVector3D &v, const QVector3D &n)
{
...
void Bat::quad1(GLfloat x1, GLfloat y1,GLfloat z1,
...
void Bat::quad(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3, GLfloat x4, GLfloat y4)
{
...
void Bat::extrude(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
